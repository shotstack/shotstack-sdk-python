...
conf = shotstack_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://api.shotstack.io/edit/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("shotstack_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'DeveloperKey' in self.api_key:
            auth['DeveloperKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-api-key',
