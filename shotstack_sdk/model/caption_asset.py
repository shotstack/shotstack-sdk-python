...
class CaptionAsset(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'src': (str,),  # noqa: E501
            'font': (CaptionFont,),  # noqa: E501
            'background': (CaptionBackground,),  # noqa: E501
    ...
    def _from_openapi_data(cls, src, *args, **kwargs):  # noqa: E501
        """CaptionAsset - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): The type of asset - set to `caption` for captions.. defaults to 'caption', must be one of ['caption', ]  # noqa: E501
