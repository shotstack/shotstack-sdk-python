...
def lazy_import():
    ...
    globals()['ElevenLabsGeneratedAssetOptions'] = ElevenLabsGeneratedAssetOptions


class ElevenLabsGeneratedAsset(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'options': (ElevenLabsGeneratedAssetOptions,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, options, *args, **kwargs):  # noqa: E501
        """ElevenLabsGeneratedAsset - a model defined in OpenAPI

        Args:
            options (ElevenLabsGeneratedAssetOptions):

        Keyword Args:
            provider (str): The name of the provider - set to `elevenlabs` for ElevenLabs.. defaults to "elevenlabs", must be one of ["elevenlabs", ]  # noqa: E501
