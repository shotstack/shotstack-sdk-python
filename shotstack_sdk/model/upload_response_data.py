...
def lazy_import():
    ...
    globals()['UploadResponseAttributes'] = UploadResponseAttributes


class UploadResponseData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'attributes': (UploadResponseAttributes,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, type, id, attributes, *args, **kwargs):  # noqa: E501
        """UploadResponseData - a model defined in OpenAPI

        Args:
            type (str): The type of resource, in this case it is an upload.
            id (str): The upload file id.
