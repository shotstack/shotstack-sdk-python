...
def lazy_import():
    ...
    globals()['DIDGeneratedAssetOptions'] = DIDGeneratedAssetOptions


class DIDGeneratedAsset(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'options': (DIDGeneratedAssetOptions,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, options, *args, **kwargs):  # noqa: E501
        """DIDGeneratedAsset - a model defined in OpenAPI

        Args:
            options (DIDGeneratedAssetOptions):

        Keyword Args:
            provider (str): The name of the provider - set to `d-id` for D-ID.. defaults to "d-id", must be one of ["d-id", ]  # noqa: E501
        ...
        provider = kwargs.get('provider', "d-id")
