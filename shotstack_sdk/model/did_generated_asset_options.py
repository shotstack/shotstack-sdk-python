...
def lazy_import():
    ...
    globals()['DIDTextToAvatarOptions'] = DIDTextToAvatarOptions


class DIDGeneratedAssetOptions(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """DIDGeneratedAssetOptions - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            avatar (str): The avatar character to generate. Select from the list of available avatars: <ul>   <li>`jack`</li>   <li>`lana`</li>   <li>`lily`</li>   <li>`matt`</li>   <li>`rian`</li> </ul>. [optional]  # noqa: E501
        """
