...
def lazy_import():
    ...
    globals()['HeyGenGeneratedAssetOptions'] = HeyGenGeneratedAssetOptions


class HeyGenGeneratedAsset(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'options': (HeyGenGeneratedAssetOptions,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, options, *args, **kwargs):  # noqa: E501
        """HeyGenGeneratedAsset - a model defined in OpenAPI

        Args:
            options (HeyGenGeneratedAssetOptions):

        Keyword Args:
            provider (str): The name of the provider - set to `heygen` for HeyGen.. defaults to "heygen", must be one of ["heygen", ]  # noqa: E501
        ...
        provider = kwargs.get('provider', "heygen")
