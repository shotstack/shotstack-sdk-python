...
def lazy_import():
    ...
    globals()['SourceResponseAttributes'] = SourceResponseAttributes


class SourceResponseData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'type': (str,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'attributes': (SourceResponseAttributes,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, type, id, attributes, *args, **kwargs):  # noqa: E501
        """SourceResponseData - a model defined in OpenAPI

        Args:
            type (str): The type of resource, in this case it is a source.
            id (str): The source file id.
