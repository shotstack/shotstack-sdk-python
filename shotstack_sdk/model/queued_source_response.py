...
def lazy_import():
    ...
    globals()['QueuedSourceResponseData'] = QueuedSourceResponseData


class QueuedSourceResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data': (QueuedSourceResponseData,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, data, *args, **kwargs):  # noqa: E501
        """QueuedSourceResponse - a model defined in OpenAPI
