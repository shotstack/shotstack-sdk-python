...
class TextToSpeechAsset(ModelNormal):
    ...
    def _from_openapi_data(cls, text, voice, *args, **kwargs):  # noqa: E501
        """TextToSpeechAsset - a model defined in OpenAPI
        ...
        Keyword Args:
            type (str): The type of asset - set to `text-to-speech` for text-to-speech.. defaults to 'text-to-speech', must be one of ['text-to-speech', ]  # noqa: E501
