...
class ShotstackImageToVideoOptions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, image_url, *args, **kwargs):  # noqa: E501
        """ShotstackImageToVideoOptions - a model defined in OpenAPI

        Args:
            image_url (str): The URL of the image to convert to video. The URL must be publicly accessible or include credentials. The image dimensions must exactly match one of the following: 1024px x 576px, 576px x 1024px or 768px x 768px.
