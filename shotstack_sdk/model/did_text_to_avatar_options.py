...
class DIDTextToAvatarOptions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, text, avatar, *args, **kwargs):  # noqa: E501
        """DIDTextToAvatarOptions - a model defined in OpenAPI

        Args:
            text (str): The text or script that the avatar will narrate.
            avatar (str): The avatar character to generate. Select from the list of available avatars: <ul>   <li>`jack`</li>   <li>`lana`</li>   <li>`lily`</li>   <li>`matt`</li>   <li>`rian`</li> </ul>
        ...
        Keyword Args:
            ...
            background (str): The background color of the video.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, text, avatar, *args, **kwargs):  # noqa: E501
        """DIDTextToAvatarOptions - a model defined in OpenAPI
