...
def lazy_import():
    ...
    globals()['GeneratedAssetErrorResponseData'] = GeneratedAssetErrorResponseData


class GeneratedAssetErrorResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'errors': ([GeneratedAssetErrorResponseData],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, errors, *args, **kwargs):  # noqa: E501
        """GeneratedAssetErrorResponse - a model defined in OpenAPI

        Args:
            errors ([GeneratedAssetErrorResponseData]): An array of errors.
