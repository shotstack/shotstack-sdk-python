...
def lazy_import():
    ...
    globals()['OpenAiGeneratedAssetOptions'] = OpenAiGeneratedAssetOptions


class OpenAiGeneratedAsset(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'options': (OpenAiGeneratedAssetOptions,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, options, *args, **kwargs):  # noqa: E501
        """OpenAiGeneratedAsset - a model defined in OpenAPI

        Args:
            options (OpenAiGeneratedAssetOptions):

        Keyword Args:
            provider (str): The name of the provider - set to `openai` for OpenAI.. defaults to "openai", must be one of ["openai", ]  # noqa: E501
