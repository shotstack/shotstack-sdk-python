...
class ShotstackDestination(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            provider (str): The destination to send rendered assets to - set to `shotstack` for Shotstack hosting and CDN.. defaults to "shotstack"  # noqa: E501
