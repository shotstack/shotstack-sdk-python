...
class AssetResponseAttributes(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (str): The unique id of the hosted asset in UUID format.. [optional]  # noqa: E501
            owner (str): The owner id of the render task.. [optional]  # noqa: E501
            ...
            status (str): The status of the asset. <ul>   <li>`importing` - the asset is being copied to the hosting service</li>   <li>`ready` - the asset is ready to be served to users</li>   <li>`failed` - the asset failed to copy or delete</li>   <li>`deleted` - the asset has been deleted</li> </ul>. [optional]  # noqa: E501
