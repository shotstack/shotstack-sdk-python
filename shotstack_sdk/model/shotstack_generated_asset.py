...
def lazy_import():
    ...
    globals()['ShotstackGeneratedAssetOptions'] = ShotstackGeneratedAssetOptions


class ShotstackGeneratedAsset(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'options': (ShotstackGeneratedAssetOptions,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, options, *args, **kwargs):  # noqa: E501
        """ShotstackGeneratedAsset - a model defined in OpenAPI

        Args:
            options (ShotstackGeneratedAssetOptions):

        Keyword Args:
            provider (str): The name of the provider - set to `shotstack` for Shotstack.. defaults to "shotstack", must be one of ["shotstack", ]  # noqa: E501
