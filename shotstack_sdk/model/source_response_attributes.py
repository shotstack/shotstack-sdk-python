...
class SourceResponseAttributes(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, owner, *args, **kwargs):  # noqa: E501
        """SourceResponseAttributes - a model defined in OpenAPI

        Args:
            id (str): The source id.
            owner (str): The owner id of the source file.
        ...
        Keyword Args:
            ...
            input (str): The original URL of an ingested source file, where it originated. Only displayed for files ingested using the [fetch source](#fetch-source) endpoint. Not displayed for direct uploads.. [optional]  # noqa: E501
            source (str): The URL of the source file hosted by Shotstack. The file at the URL can be used by the Edit API. Source file URL's consist of a base URL (AWS bucket), owner id, source id and a file named source. The extension varies depending on the type of file ingested.. [optional]  # noqa: E501
            ...
            updated (str): The time the ingestion status was last updated.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, owner, *args, **kwargs):  # noqa: E501
        """SourceResponseAttributes - a model defined in OpenAPI
