...
class Output(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'destinations': ([bool, date, datetime, dict, float, int, list, str, none_type],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, format, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            aspect_ratio (str): The aspect ratio (shape) of the video or image. Useful for social media output formats. Options are: <ul>   <li>`16:9` - regular landscape/horizontal aspect ratio (default)</li>   <li>`9:16` - vertical/portrait aspect ratio</li>   <li>`1:1` - square aspect ratio</li>   <li>`4:5` - short vertical/portrait aspect ratio</li>   <li>`4:3` - legacy TV aspect ratio</li> </ul>. [optional]  # noqa: E501
            size (Size): [optional]  # noqa: E501
            fps (float): Override the default frames per second. Useful for when the source footage is recorded at 30fps, i.e. on  mobile devices. Lower frame rates can be used to add cinematic quality (24fps) or to create smaller file size/faster render times or animated gifs (12 or 15fps). Default is 25fps. <ul>   <li>`12` - 12fps</li>   <li>`15` - 15fps</li>   <li>`24` - 24fps</li>   <li>`23.976` - 23.976fps</li>   <li>`25` - 25fps</li>   <li>`29.97` - 29.97fps</li>   <li>`30` - 30fps</li> </ul>. [optional]  # noqa: E501
